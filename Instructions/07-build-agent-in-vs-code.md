...
1. 검색 창에서 **Foundry**를 입력하고 Enter 키를 누릅니다.

1. Microsoft에서 **Foundry** 확장을 선택하고 **설치**를 클릭합니다.
...
1. VS Code 사이드바에서 **Foundry** 확장 아이콘을 선택합니다.
...
1. "프로젝트가 배포되었습니다." 팝업이 나타나면 **모델 배포** 단추를 선택합니다. 그러면 모델 카탈로그가 열립니다.
   ...
   > **팁**: 리소스 섹션에서 **모델** 옆에 있는 **+** 아이콘을 선택하거나 **F1** 키를 누르고 명령 **Foundry: 모델 카탈로그 열기**를 실행하여 모델 카탈로그에 액세스할 수도 있습니다.
...
1. 왼쪽 아래 모서리에 있는 **Foundry에서 배포**를 선택합니다.
...
1. Foundry 확장 보기에서 **리소스** 섹션을 찾습니다.

1. **에이전트** 하위 섹션 옆에 있는 **+**(더하기) 아이콘을 선택하여 새 AI 에이전트를 만듭니다.

    ![Foundry VS Code 확장에서 에이전트를 만드는 스크린샷](Media/vs-code-new-agent.png)
...
1. 디자이너 보기의 왼쪽 아래 모서리에 있는 **Foundry에서 만들기** 버튼을 선택합니다.
